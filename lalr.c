...
static void set_state_table _P_((void));
static void set_accessing_symbol _P_((void));
static void set_shift_table _P_((void));
static void set_reduction_table _P_((void));
static void set_maxrhs _P_((void));
static void initialize_LA _P_((void));
static void set_goto_map _P_((void));
static int map_goto _P_((int state, int symbol));
static void initialize_F _P_((void));
static void build_relations _P_((void));
static void add_lookback_edge _P_((int stateno, int ruleno, int gotono));
static short **transpose _P_((short **R, int n));
static void compute_FOLLOWS _P_((void));
static void compute_lookaheads _P_((void));
static void digraph _P_((short **relation));
static void traverse _P_((register int i));
...
#else
static int map_goto(state, symbol)
int state;
int symbol;
#endif
{
...
#else
static void add_lookback_edge(stateno, ruleno, gotono)
